...
const PROJECTS: Project[] = [
  {
    id: 1,
    title: "Preslae DeWork",
    description:
      "A decentralized work platform for Web3 freelancers. Built with Next.js, Solidity smart contracts, and integrated wallet connections for seamless crypto payments.",
    tech: ["Next.js", "Solidity", "Web3", "TypeScript"],
    category: "Web3",
    image: "/assets/hero.png",
    link: "https://preslae-dework.vercel.app/",
  },
  {
    id: 2,
    title: "LootBox WTF",
    description:
      "NFT lootbox platform with gamified mechanics. Features real-time blockchain interactions, dynamic rarity systems, and immersive user experience.",
    tech: ["React", "Ethereum", "Web3.js", "Node.js"],
    category: "Web3",
    image: "/assets/hero.png",
    link: "https://lootboxwtf.vercel.app/",
  },
  {
    id: 3,
    title: "Shiro Stake",
    description:
      "DeFi staking platform with yield farming capabilities. Secure smart contract integration, real-time APY calculations, and comprehensive dashboard analytics.",
    tech: ["Next.js", "Solidity", "DeFi", "MongoDB"],
    category: "Web3",
    image: "/assets/hero.png",
    link: "https://shiro-stake.vercel.app/",
  },
  {
    id: 4,
    title: "Cat Cost Calculator",
    description:
      "Interactive cost calculator for pet ownership. Clean UI with real-time calculations, responsive design, and smooth animations for better user engagement.",
    tech: ["React", "TypeScript", "CSS3", "Vercel"],
    category: "Frontend",
    image: "/assets/hero.png",
    link: "https://cat-cost.vercel.app/",
  },
  {
    id: 5,
    title: "Lucky 404 Bay",
    description:
      "Creative 404 error page with retro gaming aesthetics. Pixel-art design, interactive elements, and nostalgic gaming references for enhanced user experience.",
    tech: ["Next.js", "Framer Motion", "CSS3"],
    category: "Frontend",
    image: "/assets/hero.png",
    link: "https://lucky-404-bay.vercel.app/",
  },
  {
    id: 6,
    title: "Little Pepe Token",
    description:
      "Meme token platform with community features. Tokenomics dashboard, holder analytics, and social integration for meme coin communities.",
    tech: ["React", "Web3", "Ethers.js", "Firebase"],
    category: "Web3",
    image: "/assets/hero.png",
    link: "https://littlepepe.com/",
  },
];
